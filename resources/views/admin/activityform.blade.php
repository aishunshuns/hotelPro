...
<div class="page-content"> 
      <div class="page-header"> 
       <h1 style="float:left;"> 活动添加<small> <i class="icon-double-angle-right"></i></small> </h1> 
       ...
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         <div class="col-xs-12"> 
          ...
          <form action="{{URL('admin/activityAdd')}}" method="post" enctype="multipart/form-data">
          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
           <table id="sample-table-1" class="table table-striped table-bordered table-hover" > 
          			<tr>
          				<td width="40%" align="right">活动名称</td>
          				<td width="60%" >
          					<input type="text" name="act_name" id="act_name"><span  id="u_name"></span>
          				</td>
          			</tr>
          			<tr>
          				<td width="40%" align="right">开始时间</td>
          				<td width="60%">
          					<p class="datep"><input class="datainp" id="datebut" type="text" placeholder="请选择"  readonly name="act_start_time" onClick="jeDate({dateCell:'#datebut',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})">
                  </p>
          				</td>
          			</tr>
          			<tr>
          				...
          				<td width="60%">
          					<p class="datep"><input class="datainp" id="datebut1" type="text" placeholder="请选择"  readonly name="act_end_time" onClick="jeDate({dateCell:'#datebut1',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})">
                    </p>
          				</td>
          			</tr>
          			<tr>
          			...
          			<tr>
          				...
          				<td width="60%">
          					<textarea name="act_desc" cols="30" rows="10"></textarea>
          				</td>
          			</tr>
          			<tr>
