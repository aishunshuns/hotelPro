...
<div class="page-content"> 
      <div class="page-header"> 
       <h1 style="float:left;"> 帮助添加<small> <i class="icon-double-angle-right"></i></small> </h1> 
       <h1 style="float:right;"> <a href="{{URL('admin/helpShow')}}">帮助列表<small> <i class="icon-double-angle-right"></i></small></a></h1> 
 </div>
       ...
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         <div class="col-xs-12"> 
          ...
          <form action="{{URL('admin/helpUp')}}" method="post" enctype="multipart/form-data">
          <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
           <table id="sample-table-1" class="table table-striped table-bordered table-hover" > 
          			<tr>
          				<td width="40%" align="right">帮助描述</td>
          				<td width="60%" >
                    <input type="text" name="help_desc" value="{{$v['help_desc']}}">
          			...
          			<tr>
          				<td width="40%" align="right">帮助文件</td>
          				<td width="60%">
          					<input type="file" name="help_img">
          				</td>
          			</tr>
      
          			<tr>
          				<td width="40%" align="right" >酒店名称</td>
          				<td width="60%">

          					<select name="hotel_id">
                    <option value="">--请选择--</option>
            @foreach($res as $v1)
                <option value="{{$v1['hotel_id']}}" <?php if ($v['hotel_id']==$v1['hotel_id']) {
               echo "selected"; }?> >{{$v1['hotel_name']}}</option>
             @endforeach     
                    </select>
          				</td>
          			</tr>
