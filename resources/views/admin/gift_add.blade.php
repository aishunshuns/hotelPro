       ...
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         <div class="col-xs-12"> 
          ...
          <form action="{{url('admin/gift_addpro')}}" method="post" enctype="multipart/form-data">
          <center>
           <table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
            ...
            <tr>
              ...
              <td>
                <input type="text" name="gift_integral" />
              </td>
            </tr>
            <tr>
              <td align="center" id="dateinfo1">开始时间</td>
              <td>
                 <p class="datep"><input class="datainp" id="datebut" name="gift_start_time" type="text" placeholder="请选择"  readonly><input type="button" onClick="jeDate({dateCell:'#datebut',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})"  value="打开"></p>
              </td>
            </tr>
            <tr>
              <td align="center" id="dateinfo2">结束时间</td>
              <td>
                 <p class="datep"><input class="datainp" id="datebut2" name="gift_end_time" type="text" placeholder="请选择"  readonly><input type="button" onClick="jeDate({dateCell:'#datebut2',isTime:true,format:'YYYY-MM-DD hh:mm:ss'})" value="打开"></p>
              </td>
            </tr>
            <tr>
              <td align="center">礼品数量</td>
              <td>
                <input type="text" name="gift_stock" />
              </td>
            </tr>
            <tr>
