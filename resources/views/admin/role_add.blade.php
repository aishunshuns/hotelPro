       ...
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         <div class="col-xs-12"> 
          ...
          <form action="{{url('admin/role_add')}}" method="post" onsubmit="return funSubmit()">
          <center>
           <table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
            <tr>
              <td align="center">角色添加</td>
              <td>
                <input type="text" name="role_name" onblur="fun()"/><span id="span"></span>
              </td>
            </tr>
            <tr>
  ...
  <script type="text/javascript">
      ...
      function fun()
      {
        ...
        if (role_name == '') {
          ...
          var url = "admin/role_add";
          var data = {act:'formCheck',role_name:role_name};
          $.ajax({  
            type : "GET",  
            data : data,  
            success : function(e){  
