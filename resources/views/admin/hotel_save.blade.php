@include('admin/header')
     <div class="page-content"> 
      <div class="page-header"> 
       <h1>酒店信息修改<small> <i class="icon-double-angle-right"></i></small> </h1> 
      </div>
      <!-- /.page-header --> 
      <div class="row"> 
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         <div class="col-xs-12"> 
          ...
          <form action="{{URL('hotelUpdate')}}" method="post" enctype="multipart/form-data">
          ...
          <input type="hidden" name="hotel_id" value="{{$arr['hotel_id']}}">
           <table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
              <tr>
                <th>酒店名称：</th>
                <td>
                  <input type="text" name="hotel_name" value="{{$arr['hotel_name']}}" placeholder="请输入酒店名称">
                </td>
              </tr>
              <tr>
                <th>酒店所在城市：</th>
              ...
              <tr>
                <th>酒店地址：</th>
                <td>
                  <textarea name="hotel_address" id="hotel_address" cols="60" rows="5" placeholder ="请输入详细的地址，以便核查">{{$arr['hotel_address']}}</textarea>
                </td>
              </tr>
              <tr>
                <th>酒店图片：</th>
              ...
              <tr>
                <th>酒店联系电话：</th>
                <td>
                  <input type="text" name="hotel_phone" id="hotel_phone" value="{{$arr['hotel_phone']}}">
                </td>
              </tr>
              <tr>
                <th>酒店描述：</th>
                <td>
                  <textarea name="hotel_desc" id="hotel_desc" cols="60" rows="5">{{$arr['hotel_desc']}}</textarea>
                </td>
              </tr>
              <tr>
                <th>酒店类型：</th>
                <td>
                  ...
                  @foreach($arr['type'] as $v)
                    <option value="{{$v['hotel_type_id']}}" <?php if($v['hotel_type_id']==$arr['hotel_type']){ echo "selected";}?> >{{$v['hotel_type_name']}}</option>
                  @endforeach
                  </select>
                </td>
              </tr>
              <tr>
                <th>酒店地址IP：</th>
                <td>
                  <input type="text" name="hotel_ip_x" value="{{$arr['hotel_ip_x']}}">*<input type="text" name="hotel_ip_y" id="hotel_ip_y" value="{{$arr['hotel_ip_y']}}">
                </td>
              </tr>
           </table> 
